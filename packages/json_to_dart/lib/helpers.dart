...
bool _isDoubleWithExponential(
    String? integer, String? comma, String? exponent) {
  final integerNumber = int.tryParse(integer ?? '0') ?? 0;
  final exponentNumber = int.tryParse(exponent ?? '0') ?? 0;
  final commaNumber = int.tryParse(comma ?? '0') ?? 0;
